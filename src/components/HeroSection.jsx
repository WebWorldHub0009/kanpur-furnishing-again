          ...
          >
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-20 relative z-10 mt-12 sm:mt-16 md:mt-20">
              ...
              <p
                ...
                style={{ color: colors.taupe }}
              >
                Handpicked fabrics, luxury finishes, and modern designs crafted to
                enhance your living spaces. Perfectly tailored to fit any window, our
                drapes offer unmatched elegance and sophistication.
              </p>
            </div>
          ...
          >
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-20 relative z-10 mt-12 sm:mt-16 md:mt-20">
              ...
              <h1
                ...
                style={{ color: colors.cream }}
              >
                Transform Walls with{" "}
                <span style={{ color: colors.maroon }}>Premium Vinyl</span>
              </h1>
              <p
                className="mt-3 sm:mt-6 text-sm sm:text-base md:text-lg max-w-xl font-sans text-taupe drop-shadow-md"
                style={{ color: colors.taupe }}
              >
                From textured finishes to modern patterns, our wallpapers add a
                luxury vibe to your interiors.
              </p>
            </div>
